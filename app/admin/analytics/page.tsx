...
import { Users, GraduationCap, Settings, Bell, LogOut, Search, ArrowLeft, BarChart3 } from "lucide-react"
    ...
    <div className="flex h-screen bg-gradient-to-br from-pink-100 via-purple-100 to-blue-200">
      ...
      <aside className="w-64 bg-white/70 backdrop-blur-xl shadow-xl rounded-r-3xl">
        ...
        <nav className="mt-8 px-4 space-y-2">
          ...
          <Link href="/admin/analytics" className="flex items-center px-4 py-3 text-purple-600 bg-purple-50 rounded-xl shadow-sm">
        ...
        <div className="bg-white/70 backdrop-blur-xl rounded-3xl shadow-xl p-8">
          <div className="flex items-center mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">Analisis data dan statistik sistem</p>
            </div>
          </div>
          ...
          <div className="py-20 text-center">
            ...
            <h2 className="text-xl font-bold text-gray-800 mb-2">Halaman Analytics</h2>
            <p className="text-gray-600 max-w-md mx-auto">
              Fitur analytics untuk melihat statistik dan laporan sistem akan tersedia segera.
            </p>
          </div>
        </div>
      </main>
